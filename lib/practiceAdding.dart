...
class PracticeAdding extends StatefulWidget {
  const PracticeAdding({super.key});
  @override
  State<PracticeAdding> createState() => _PracticeAdding();
}

class _PracticeAdding extends State<PracticeAdding>{

  // gets the map of the questions and answers
  //List<Map<String, dynamic>> quesAndAns = qna().getAdding();
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      questionDisplay(adding[qNum[index]]['ques'])
                  ),
                  buttons(context, adding[qNum[index]]['ans'], index, adding[qNum[index]]['desc']),
                ],
              ),
            ),
          )
...
// awesomedialog for correct answers
  ...
  questionAscension(BuildContext context){
    if (index < 4){
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => const CongratulationsAdding()));
      index = 0;
    }
  }
}
