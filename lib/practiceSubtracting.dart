...
class PracticeSubtracting extends StatefulWidget {
  const PracticeSubtracting({super.key});
  @override
  State<PracticeSubtracting> createState() => _PracticeSubtracting();
}

class _PracticeSubtracting extends State<PracticeSubtracting>{
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      questionDisplay(subtracting[qNum[index]]['ques'])
                  ),
                  buttons(context, subtracting[qNum[index]]['ans'], index, subtracting[qNum[index]]['desc']),
                ],
              ),
            ),
          )
...
// awesomedialog for correct answers
  ...
  questionAscension(BuildContext context){
    if (index < 4){
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => const CongratulationsSubtracting()));
      index = 0;
    }
  }
}
...
gatherChoices(int index){
  List<int> choices = [];
  int correct = subtracting[index]['ans'];
